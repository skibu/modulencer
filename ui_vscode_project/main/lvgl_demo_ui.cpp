...
#include "lvgl.h"
//#include "lv_obj.h" // Include the header defining lv_obj_draw_part_dsc_t
//#include "lv_draw.h" // Include the header defining lv_obj_draw_part_dsc_t
//#include "lv_chart.h" 
...
//         uint32_t p_act =
//             (start_point + dsc->id) % cnt; /*Consider start point to get the index of the array*/
...
//     lv_chart_set_next_value2(chart, lv_chart_get_series_next(chart, NULL), lv_rand(0, 200),
//                              lv_rand(0, 1000));
// }

// void example_lvgl_demo_ui(lv_display_t *disp) {
//     lv_obj_t *scr = lv_display_get_scr_active(disp);
